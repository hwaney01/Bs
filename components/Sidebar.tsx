...
const Sidebar: React.FC<SidebarProps> = ({ navItems, currentView, setCurrentView }) => {
  ...
  return (
    <aside className="w-64 bg-slate-800/50 backdrop-blur-sm border-l border-slate-700/50 flex flex-col justify-between p-4">
      <div>
        <div className="p-4 mb-6">
          <h1 className="text-2xl font-bold text-white text-center">لوحة الخدمة</h1>
        </div>
        <nav>
          <ul>
